...
namespace PPeXM64
{
	public static class Logger
	{
		...
		public static void Dump()
		{
			...
			System.IO.File.WriteAllText("B:\\accessed.csv",
				AccessedList.Select(x => x.Key + "," + x.Value.ToString()).Aggregate((a, b) => a + "\r\n" + b));
			System.IO.File.WriteAllText("B:\\extension.csv",
				ExtensionList.Select(x => x.Key + "," + x.Value.ToString()).Aggregate((a, b) => a + "\r\n" + b));
		}
	}
}